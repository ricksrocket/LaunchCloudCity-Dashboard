      ...
      <div>
        ...
        >
          <ColumnsDirective>
            ...
            <ColumnDirective field="Date" headerText="Date"></ColumnDirective>
            ...
            <ColumnDirective
              headerText="NewParachuteSize"
              template="<button class='e-btn e-flat' data-command='calculate'>Calculate</button>"
            />
            <ColumnDirective
              headerText="Edit"
              template="<button class='e-btn e-flat' data-command='edit'>Edit</button>"
            />
            <ColumnDirective
              headerText="Delete"
              template="<button class='e-btn e-flat' data-command='delete'>Delete</button>"
            />
          </ColumnsDirective>
